...
from env import DATASETS_DIR, PROCESSED_DATA_DIR, RECOMMENDATION_URL_PREFIX
...
def upload_kpop_face_match():
    try:
        ...
        # フルパスを作成
        full_photo_url = url_for(
            "idol_suggestion.serve_photo", idol=idol_name, filename=f"{idol_name}.jpg", _external=False
        )
