...
def fuse_features_with_norm(stacked_embeddings, stacked_norms, fusion_method="norm_weighted_avg"):
    ...
    if fusion_method == "norm_weighted_avg":
        ...
        raise ValueError(
            "not implemented yet. please refer to https://github.com/deepinsight/insightface/blob/5d3be6da49275602101ad122601b761e36a66a01/recognition/_evaluation_/ijb/ijb_11.py#L296"
        )
...
if __name__ == "__main__":
    ...
    tinyface_test = tinyface_helper.TinyFaceTest(
        tinyface_root=args.data_root, alignment_dir_name="aligned_pad_0.1_pad_high"
    )
